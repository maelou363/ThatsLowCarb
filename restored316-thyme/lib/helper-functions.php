 ...
 * Thyme Theme.
 *
 * This file adds the required helper functions used in the Thyme Theme.
 *
 * @package Thyme Theme
 ...
 */
function thyme_get_default_link_color() {
 ...
 */
function thyme_get_default_button_color() {
 ...
 */
function thyme_get_default_primary_color() {
 ...
 * @return string Hex color code for primary color.
 */
function thyme_get_default_banner_color() {
 ...
 */
function thyme_get_default_accent_color() {
 ...
 * @return string Hex color code for accent color.
 */
function thyme_get_default_body_color() {
 ...
 */
function thyme_color_contrast( $color ) {
 ...
 */
function thyme_color_brightness( $color, $change ) {
...
add_filter( 'body_class', 'thyme_maybe_add_menu_body_class' );
/**
 ...
 */
function thyme_maybe_add_menu_body_class( $classes ) {
...
/**
 * Gets the default image for the nav mini logo section.
 *
 * @return string defaultimage for the nav mini logo section.
 *
 * @since 1.2.0
 */
function thyme_get_default_mini_logo() {
	return get_stylesheet_directory_uri() . '/images/nav-icon.png';
}
 ...
 * @since 1.2.0
 */
function thyme_get_default_footer_logo() {
	return get_stylesheet_directory_uri() . '/images/footer-logo.png';
}
 ...
 */
function thyme_get_default_top_banner_text() {

	return __( 'Join my newsletter list to be the first to hear our latest news! <a href="#"> Learn More</a>', 'thyme-pro' );

}

// Add FacetWP Support.
add_filter( 'body_class', 'recipe_blogger_body_class', 88, 1 );
 ...
 */
function recipe_blogger_body_class( $classes ) {
